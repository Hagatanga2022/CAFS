<template>
  <q-layout  class="transition"  view="lHh Lpr lFf">
    ...
    <q-page-container style="padding-left:0px;padding-top:0px">
      <q-item-label class="column items-center" style="background-color:black;width:100%;height:90vh;padding-top:3%">
        <q-item-label class="row items-center" style="background-color:white;width:50%;height:8%;margin-bottom:4%;border-radius:10px;padding-left:2%"> 
          <img style="margin-right:5%" class="home-pic" src="../images/account-circle-outline-blue.png">
          <q-input class="warn-input"   :input-style="{ height:'50px'}"  style="width:60%;padding:0px;" label='Escreva um texto de aviso aos bolsistas'></q-input>
        </q-item-label>
        <q-item-label style="background-color:white;width:50%;height:40%;border-radius:10px"> 
        </q-item-label>
      </q-item-label>
      <router-view />
    </q-page-container>
