<template>
  <q-layout view="lHh Lpr lFf">
    <q-header>
      <q-toolbar class="upperbar-white"
      >
        <q-toolbar-title 
        class="column"
        >
          <div class="title-white row justify-start items-center">
            Bolsista
          </div>
        </q-toolbar-title>
    ...
    >
      <q-list class="sidebar-content ">
        ...
        <q-item-label class="tres">
        <div class="flex justify-center">
          Bolsistas
          <q-item-label class="add-bolsista column justify-center">
            <q-btn class="btn row">
              Gerenciar bolsista
            </q-btn>
            <q-btn class="btn row">
...
import Icon from '../images/account-circle-outline.png'
const linksList = [
  {
    title: 'Pesquisar',
    icon: 'search',
...
@keyframes color{
  10% {background-color:white;color:#1D6382 ;}
} 
.sidebar-content{
  height: 100%;
}
